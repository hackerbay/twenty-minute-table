...
def anatomy(c='#C1502E', tint='#FAEDE7', w='64mm'):
    def bars(x, y, widths, gap=6.2, h=2.6, fill='#828C84', op=.42, rx=1.3):
        out = ''
    ...
    macv = ''.join(f'<rect x="{24+35.2*i}" y="263" width="21" height="5" rx="2" fill="{c}" opacity=".55"/>'
                   f'<rect x="{27+35.2*i}" y="271" width="15" height="2.6" rx="1.3" fill="#828C84" opacity=".45"/>'
                   for i in range(5))
...
<rect x="52" y="26" width="100" height="9" rx="3" fill="#1B201D" opacity=".85"/>
<rect x="52" y="41" width="27" height="7" rx="3.5" fill="{c}"/>{bars(84, 42.5, [30, 22, 20], 0)}
<rect x="84" y="42.5" width="30" height="3" rx="1.5" fill="#828C84" opacity=".42"/>
<rect x="119" y="42.5" width="22" height="3" rx="1.5" fill="#828C84" opacity=".42"/>
<circle cx="180" cy="38" r="{r}" fill="none" stroke="{c}" stroke-opacity=".18" stroke-width="3"/>
...
<rect x="26" y="72" width="150" height="4" rx="2" fill="{c}" opacity=".5"/>
<rect x="26" y="81" width="96" height="4" rx="2" fill="{c}" opacity=".5"/>
<rect x="17" y="94" width="24" height="3.2" rx="1.6" fill="{c}" opacity=".75"/>
...
<rect x="93" y="94" width="24" height="3.2" rx="1.6" fill="{c}" opacity=".75"/>
<line x1="93" y1="102" x2="193" y2="102" stroke="#E2DACA" stroke-width="1"/>
{bars(93, 108, [100, 96, 62], 6.6)}
<rect x="93" y="128" width="20" height="3.2" rx="1.6" fill="{c}" opacity=".75"/>
...
<rect x="17" y="236" width="18" height="3" rx="1.5" fill="{c}" opacity=".7"/>
<rect x="110" y="236" width="24" height="3" rx="1.5" fill="{c}" opacity=".7"/>
{bars(17, 243, [76, 62], 6.2)}{bars(110, 243, [80, 58], 6.2)}
<rect x="17" y="258" width="176" height="20" rx="3" fill="{tint}"/>{macs}{macv}
<rect x="17" y="286" width="22" height="3" rx="1.5" fill="{c}" opacity=".7"/>
<rect x="45" y="286" width="96" height="3" rx="1.5" fill="#828C84" opacity=".42"/>
